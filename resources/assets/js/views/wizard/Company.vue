<template>
    <div
        class="relative bg-body z-10 rounded-lg shadow-2xl p-5 sm:p-10 full-height-mobile"
        style="height: 675px"
    >
        ...
        >
            <div
                v-if="pageLoad"
                class="absolute inset-0 w-full h-full bg-white rounded-lg flex items-center justify-center z-50"
            >
            ...
            <div class="overflow-x-visible overflow-y-auto menu-scroll mt-1">
                ...
                >
                    <div class="relative">
                        ...
                        >
                            <span
                                class="material-icons form-spin animate-spin text-9xl"
                                >data_usage</span
                            >
                        </div>
                        ...
                        >
                            <div
                                class="grid sm:grid-cols-6 gap-x-8 gap-y-6 my-3.5 menu-scroll gap-10"
                            >
                                <div class="sm:col-span-3">
                                    <base-input
                                        ...
                                        :placeholder="
                                            translations.company.tax_number
                                        "
                                ...
                                <div class="sm:col-span-3">
                                    <akaunting-date
                                        not-required
                                        :title="
                                            translations.company.financial_start
                                        "
                                        ...
                                        :form-error="
                                            onFailErrorGet('financial_start')
                                        "
                                    ></akaunting-date>
                                </div>
                                ...
                                <div class="sm:col-span-3 grid gap-y-4">
                                    ...
                                    <div class="sm:col-span-3">
                                        <base-input
                                            not-required
                                            :label="
                                                translations.company.country
                                            "
                                            :error="onFailErrorGet('country')"
                                        >
                                            <el-select
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <akaunting-dropzone-file-upload
                                        ref="dropzoneWizard"
                                        class="form-file dropzone-column"
                                        style="width: 10.8rem; height: 10.8rem"
                                    ...
                                    <div
                                        v-if="onFailErrorGet('logo')"
                                        class="text-red text-sm mt-1 block"
                                        v-html="onFailErrorGet('logo')"
                                    ></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex items-center justify-center mt-5 gap-x-10">
                <base-button
                    class="w-1/2 flex items-center justify-center px-6 py-1.5 text-base rounded-lg bg-transparent hover:bg-gray-100"
                    @click="next()"
                >
...
export default {
    ...
    created() {
        if (document.documentElement.lang) {
            ...
            if (lang_split[0] !== "en") {
                const lang = require(`flatpickr/dist/l10n/${lang_split[0]}.js`)
                    .default[lang_split[0]];
    ...
    methods: {
        ...
        onEditSave(event) {
            ...
            FormData.prototype.appendRecursive = function (
                data,
                wrapper = null,
            ) {
